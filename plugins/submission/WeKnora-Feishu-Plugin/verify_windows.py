...
def main():
    ...
    if public:
        ...
        if not runner.exists() or not link:
            raise SystemExit("Public 0.2.0 requires native stdio verification: run from the WeKnora checkout with WEKNORA_FEISHU_TEST_URL and WEKNORA_PYTHON_PUBLIC_BUNDLE set; see PUBLIC_LINKS.md")
