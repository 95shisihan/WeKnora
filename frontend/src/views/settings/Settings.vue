...
const navItems = computed(() => {
  ...
  const all: NavItem[] = [
    ...
    { key: 'plugins', icon: 'extension', label: t('pluginSettings.navLabel') },
...
const navGroups = computed<NavGroup[]>(() => {
  ...
  return [
    ...
    },
    {
      ...
      items: pickItems(['system-global', 'plugins', 'runtime-queues', 'platform-api-keys', 'system-audit-log']),
    },
    {
      key: 'platform',
...
const handleClose = () => {
  ...
  if (route.path === '/platform/settings') {
    ...
    if (sec === 'system-global' || sec === 'plugins' || sec === 'runtime-queues' || sec === 'platform-api-keys' || sec === 'system-audit-log') {
