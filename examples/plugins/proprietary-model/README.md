...
完整接口、错误/取消规则与权限说明见 [模型插件开发文档](../../../plugin/MODEL-INFERENCE.md)。独立脚手架也随附本地 `MODEL-INFERENCE.md`。

## 独立开发

从 WeKnora 主仓运行 `python plugin/scaffold_model_plugin.py <不存在的目录> --module example.org/my-model-plugin`，然后进入生成目录：
